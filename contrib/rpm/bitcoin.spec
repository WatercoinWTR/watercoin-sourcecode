...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 12669
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 12670
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 22669
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 22670
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 12669
	%{_sbindir}/semanage port -d -p tcp 12670
	%{_sbindir}/semanage port -d -p tcp 22669
	%{_sbindir}/semanage port -d -p tcp 22670
